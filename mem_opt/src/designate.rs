...
//                     ast::Command::SetMemLoc(args) => args.to_mem_locs(),
//                     ast::Command::Copy(args) => args.to_mem_locs(),
//                     ast::Command::SetStack(args) => args.to_mem_locs(),
...
//                     ast::Command::SetMemLoc(args) => ast::Command::SetMemLoc(args.to_rmem(temp_m)),
//                     ast::Command::Copy(args) => ast::Command::Copy(args.to_rmem(temp_m)),
//                     ast::Command::SetStack(args) => ast::Command::SetStack(args.to_rmem(temp_m)),
//                     ast::Command::Deref(args) => ast::Command::Deref(args.to_rmem(temp_m)),
//                     ast::Command::Add(args) => ast::Command::Add(args.to_rmem(temp_m)),
//                     ast::Command::Sub(args) => ast::Command::Sub(args.to_rmem(temp_m)),
//                     ast::Command::Mul(args) => ast::Command::Mul(args.to_rmem(temp_m)),
//                     ast::Command::Div(args) => ast::Command::Div(args.to_rmem(temp_m)),
//                     ast::Command::Mod(args) => ast::Command::Mod(args.to_rmem(temp_m)),
//                     ast::Command::Jump(args) => ast::Command::Jump(args.to_rmem(temp_m)),
//                     ast::Command::Out(args) => ast::Command::Out(args.to_rmem(temp_m)),
//                     ast::Command::In(args) => ast::Command::In(args.to_rmem(temp_m)),
//                     ast::Command::Exit => ast::Command::Exit,
//                     ast::Command::Branch(args) => ast::Command::Branch(args.to_rmem(temp_m)),
//                     ast::Command::Eq(args) => ast::Command::Eq(args.to_rmem(temp_m)),
//                     ast::Command::Lte(args) => ast::Command::Lte(args.to_rmem(temp_m)),
//                     ast::Command::Neq(args) => ast::Command::Neq(args.to_rmem(temp_m)),
//                     ast::Command::Not(args) => ast::Command::Not(args.to_rmem(temp_m)),
//                 };
...
//             ast::Expr::Value(_) => Vec::new(),
//         }
//     }

//     fn to_rmem(&self, temp_m: &mut TempManager) -> Arc<Self::RMem> {
//         let expr = match self {
//             ast::Expr::MemLoc(umem) => ast::Expr::MemLoc(temp_m.rmem(umem)),
...
// impl HasMemLocs for ast::UnaryArgs<ast::UMemLoc> {
//     type RMem = ast::UnaryArgs<RMemLoc>;

//     fn to_mem_locs(&self) -> Vec<Arc<ast::UMemLoc>> {
//         chain!([self.dest.clone()], self.src.to_mem_locs()).collect()
//     }

//     fn to_rmem(&self, temp_m: &mut TempManager) -> Arc<Self::RMem> {
//         Arc::new(ast::UnaryArgs { dest: temp_m.rmem(&self.dest), src: self.src.to_rmem(temp_m) })
//     }
// }
...
//     fn to_mem_locs(&self) -> Vec<Arc<ast::UMemLoc>> {
//         chain!([self.dest.clone()], self.left.to_mem_locs(), self.right.to_mem_locs()).collect()
//     }
...
// impl HasMemLocs for ast::VoidUnaryArgs<ast::UMemLoc> {
//     type RMem = ast::VoidUnaryArgs<RMemLoc>;

//     fn to_mem_locs(&self) -> Vec<Arc<ast::UMemLoc>> {
//         self.src.to_mem_locs()
//     }

//     fn to_rmem(&self, temp_m: &mut TempManager) -> Arc<Self::RMem> {
//         Arc::new(ast::VoidUnaryArgs { src: self.src.to_rmem(temp_m) })
//     }
// }

// impl HasMemLocs for ast::NullaryArgs<ast::UMemLoc> {
//     type RMem = ast::NullaryArgs<RMemLoc>;
...
//     fn to_rmem(&self, temp_m: &mut TempManager) -> Arc<Self::RMem> {
//         Arc::new(ast::NullaryArgs { dest: temp_m.rmem(&self.dest) })
//     }
// }

// impl HasMemLocs for ast::CondArgs<ast::UMemLoc> {
//     type RMem = ast::CondArgs<RMemLoc>;

//     fn to_mem_locs(&self) -> Vec<Arc<ast::UMemLoc>> {
//         chain!(self.cond.to_mem_locs(), self.jump_label.to_mem_locs()).collect()
//     }

//     fn to_rmem(&self, temp_m: &mut TempManager) -> Arc<Self::RMem> {
//         Arc::new(ast::CondArgs {
//             cond: self.cond.to_rmem(temp_m),
//             jump_label: self.jump_label.to_rmem(temp_m),
//         })
//     }
// }

// impl HasMemLocs for ast::CopyToStackArgs<ast::UMemLoc> {
//     type RMem = ast::CopyToStackArgs<RMemLoc>;

//     fn to_mem_locs(&self) -> Vec<Arc<ast::UMemLoc>> {
//         chain!(self.dest_ref.to_mem_locs(), self.val.to_mem_locs()).collect()
//     }

//     fn to_rmem(&self, temp_m: &mut TempManager) -> Arc<Self::RMem> {
//         Arc::new(ast::CopyToStackArgs {
//             dest_ref: self.dest_ref.to_rmem(temp_m),
//             val: self.val.to_rmem(temp_m),
//         })
//     }
// }
